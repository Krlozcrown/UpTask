(function(){
    ...
    function mostrarFormulario(editar = false, tarea = {}){
        ...
        modal.innerHTML = `
            <form class="formulario nueva-tarea">
                ...
                <div class="opciones">
                    <input type="submit" class="submit-nueva-tarea" value="${tarea.nombre ? 'Guarda Cambios' : 'Agregar Tarea'}"/>
    ...
    function mostrarAlerta(mensaje, tipo, referencia){
        //Prevenir que ya exista una alerta
        ...
        //Inserta la alerta anes del legend
    ...
    //Consultarr el servidor para agregar la tarea al proyecto actual
    async function agregarTarea(tarea){
        ...
        try {
            ...
            if(resultado.tipo === 'exito'){
                ...
                //Agrear el objeto de tarea al arreglo de tareas
                const tareaObj = {
